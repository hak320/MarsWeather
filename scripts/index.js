...
const imperalRadio = document.getElementById('fah')
...
getWeather().then(sols => {
    ...
    displayPrevoiousSols(sols)
    updateUnits()

    unitToggle.addEventListener('click', () => {
        let metricUnits = !isMetric()
        metricRadio.checked = metricUnits
        imperalRadio.checked = !metricUnits
        displaySelectedSol(sols)
        displayPrevoiousSols(sols)
        updateUnits()
    })
    ...
    imperalRadio.addEventListener('click', () => {
        displaySelectedSol(sols)
        displayPrevoiousSols(sols)
        updateUnits()
    })
...
function displayPrevoiousSols(sols) {
        ...
        .then(data => {
            ...
            return Object.entries(solData).map(([sol, data]) => {
                return {
                    ...
                    windSpeeDirectionDegrees: data.WD.most_common.compass_degrees,
                    windSpeeDirectionCardinal: data.WD.most_common.compass_point,
